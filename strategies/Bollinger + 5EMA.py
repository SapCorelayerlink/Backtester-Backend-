...
class BB5EMAStrategy(StrategyBase):
    ...
    def __init__(self, name: str, broker: 'BrokerBase', params: dict = None):
        ...
        self.timeframe = self.params.get('timeframe', '1h')  # Flexible - can be used on any timeframe
    ...
    async def init(self):
        ...
        print(f"Symbol: {self.symbol}, Timeframe: {self.timeframe} (Flexible - any timeframe)")
